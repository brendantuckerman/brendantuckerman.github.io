    ...
    return(
        <div className="wrapper flex flex-col w-[100vw] text-center">
            ...
            <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg border-4 border-slate-200 p-10">
                <img class=" w-full h-96 md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg" src="../img/yam.png" alt="" />
                ...
                <p class="text-gray-700 text-base mb-4">
                    ...
                    <div className="buttons p-2">
                        <a href="https://mrmaverick79.github.io/you-autocomplete-me/" target="_blank" >
                        <button type="button" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-20 m-2">Demo</button></a> <a href="https://github.com/MrMaverick79/you-autocomplete-me"><button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-20">GitHub</button></a>
        ...
        <div class="flex justify-center mt-10">
            <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg border-4 border-slate-200 p-5">
                <img class=" w-full h-96 md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg" src="../img/hookie.png" alt="a screenshot from youautocomplete me, showing one of the poems." />
                <div class="p-2 flex flex-col justify-start">
                ...
                Full-stack project allowing users to store, add, and sort online bookmarks. Also uses a FireFox browser extension so user can add their favourites from anywhere.
                    ...
                    <div className="buttons p-2">
                        <a href="https://hookiebookmarks.herokuapp.com/" target="_blank" >
                        <button type="button" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-20 m-2">Demo</button></a> <a href="https://github.com/MrMaverick79/hookie-app"><button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-20">GitHub</button></a>
        ...
        <div class="flex justify-center mt-10">
            <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg border-4 border-slate-200 p-5">
                ...
                A demonstration of recursion and the use of the minimax algorithm in a web-based Tic Tac Toe app. The AI considers every possibly move in every possible square, so you can't beat it when it is set to "Impossible".
                    ...
                    <div className="buttons p-2">
                        <a href="https://mrmaverick79.github.io/project0/" target="_blank" >
                        <button type="button" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-20 m-2">Demo</button></a> <a href="https://github.com/MrMaverick79/project0"><button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-20">GitHub</button></a>
